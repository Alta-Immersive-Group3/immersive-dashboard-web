...
const MenteeEdit = () => {
  ...
  const fetchMenteeByID = async () => {
    await api
      ...
      .then((response) => {
        const { data } = response.data;
        formikAdd.setFieldValue('full_name', data.full_name);
        formikAdd.setFieldValue('nick_name', data.nick_name);
        formikAdd.setFieldValue('email', data.email);
        formikAdd.setFieldValue('current_address', data.current_address);
        formikAdd.setFieldValue('home_address', data.home_address);
        formikAdd.setFieldValue('gender', data.gender);
        formikAdd.setFieldValue('phone', data.phone);
        formikAdd.setFieldValue('telegram', data.telegram);
        formikAdd.setFieldValue('emergency_name', data.emergency_name);
        formikAdd.setFieldValue('emergency_status', data.emergency_status);
        formikAdd.setFieldValue('emergency_phone', data.emergency_phone);
        formikAdd.setFieldValue('id_class', data.id_class);
        formikAdd.setFieldValue('id_status', data.id_status);
        formikAdd.setFieldValue('education_type', data.education_type);
        formikAdd.setFieldValue('institution', data.institution);
        formikAdd.setFieldValue('major', data.major);
        formikAdd.setFieldValue('graduate', data.graduate);
      })
      .catch((error) => {
        MySwal.fire({
          icon: 'error',
  ...
  const editMentee = async (datad: object) => {
    await api
      .editMenteeById(ckToken, mentee_id, datad)
      .then((response) => {
      ...
      >
        ...
        >
          <div className="flex flex-col gap-3">
            ...
            <p className="text-secondary tracking-wide text-xl">Mentee Edit</p>
          </div>
